      ...
      <aside class="w-80 bg-main text-content fixed top-0 left-0 h-screen overflow-y-auto z-50 border-r border-border-base">
        <div class="p-8 border-b border-border-base">
          <div class="flex items-center gap-4">
            ...
            <h1 class="text-xl font-semibold text-slate-900">Admin</h1>
          </div>
        </div>

        <nav class="mt-4">
          <div class="px-4 mb-2">
            <p class="text-xs font-semibold text-slate-400 uppercase  px-2">Main</p>
          </div>
          ...
          <div class="px-4 mt-8 mb-2">
            <p class="text-xs font-semibold text-slate-400 uppercase  px-2">Content</p>
          </div>
          <ul class="space-y-1 px-2">
            <li>
          ...
          <div class="px-4 mt-8 mb-2">
            <p class="text-xs font-semibold text-slate-400 uppercase  px-2">Applications</p>
          </div>
          <ul class="space-y-1 px-2">
            <li>
