      ...
      <form [formGroup]="coachForm" (ngSubmit)="save()" class="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
          ...
          <div class="bg-white rounded border border-border-base p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">Full Name</label>
                <input type="text" formControlName="name" placeholder="e.g. Magnus Carlsen" class="px-4 py-3 bg-subtle border border-border-base rounded border border-border-base outline-none   ">
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">Professional Title</label>
                <input type="text" formControlName="title" placeholder="e.g. Grandmaster & World Champion" class="px-4 py-3 bg-subtle border border-border-base rounded border border-border-base outline-none   ">
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">FIDE Rating</label>
                <input type="number" formControlName="fideRating" placeholder="e.g. 2850" class="px-4 py-3 bg-subtle border border-border-base rounded border border-border-base outline-none   ">
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">Location</label>
                <input type="text" formControlName="location" placeholder="e.g. Oslo, Norway" class="px-4 py-3 bg-subtle border border-border-base rounded border border-border-base outline-none   ">
              </div>
            </div>

            <div class="flex flex-col gap-1.5">
              <label class="text-xs font-semibold  uppercase  mb-1 px-1">Short Catchphrase / Intro</label>
              <input type="text" formControlName="shortInfo" placeholder="A brief one-liner for search results" class="px-4 py-3 bg-subtle border border-border-base rounded border border-border-base outline-none   ">
            </div>

            <div class="flex flex-col gap-1.5">
              <label class="text-xs font-semibold  uppercase  mb-1 px-1">Biography</label>
              <textarea formControlName="bio" rows="6" placeholder="Tell the story of the coach..." class="px-4 py-3 bg-subtle border border-border-base rounded border border-border-base outline-none   "></textarea>
            </div>
          </div>
              ...
              <div formArrayName="playingExperience" class="space-y-2">
                @for (ctrl of playingExperience.controls; track $index) {
                  <div class="flex gap-2">
                    <input type="text" [formControlName]="$index" class="flex-1 px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    " placeholder="Achievement or tournament win...">
            ...
            <div class="space-y-3 mt-6">
              ...
              <div formArrayName="teachingExperience" class="space-y-2">
                @for (ctrl of teachingExperience.controls; track $index) {
                  <div class="flex gap-2">
                    <input type="text" [formControlName]="$index" class="flex-1 px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    " placeholder="Previous students or coaching roles...">
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white rounded border border-border-base p-8 space-y-6">
            ...
            <div class="flex flex-col gap-1.5">
              <label class="text-xs font-semibold  uppercase  mb-1 px-1">Profile Picture</label>
              
              <div 
                (click)="fileInput.click()"
                class="relative group cursor-pointer aspect-square rounded border-2  border-border-base hover:border-blue-500 overflow-hidden flex flex-col items-center justify-center bg-subtle"
              >
                @if (imagePreview()) {
            ...
            <div class="flex flex-col gap-1.5">
              <label class="text-xs font-semibold  uppercase  mb-1 px-1">Coaching Type</label>
              <select formControlName="coachingType" class="px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    ">
            ...
            <div class="flex flex-col gap-1.5">
              <label class="text-xs font-semibold  uppercase  mb-1 px-1">Availability</label>
              <input type="text" formControlName="availability" placeholder="e.g. Mon-Fri, 10am - 6pm" class="px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    ">
            </div>

            <div class="flex items-center gap-3 p-4 bg-subtle rounded border border-border-base">
          ...
          <div class="bg-white rounded border border-border-base p-8 space-y-6" formGroupName="socialMedia">
            ...
            <div class="space-y-4">
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">Twitter/X</label>
                <input type="text" formControlName="twitter" placeholder="username" class="px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    ">
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">Twitch</label>
                <input type="text" formControlName="twitch" placeholder="channel" class="px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    ">
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">YouTube</label>
                <input type="text" formControlName="youtube" placeholder="channel url" class="px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    ">
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold  uppercase  mb-1 px-1">Lichess</label>
                <input type="text" formControlName="lichess" placeholder="username" class="px-4 py-3 bg-subtle border border-border-base rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20    ">
              </div>
            </div>
          </div>
