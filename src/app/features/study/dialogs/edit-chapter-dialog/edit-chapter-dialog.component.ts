        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <input
              ...
              class="w-full px-3 py-2.5 rounded-xl text-sm border border-border-base bg-main text-content outline-none placeholder:text-muted/50"
              autofocus
              (keyup.enter)="onSave()"
            />
          </div>
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="relative w-full">
              <select
                ...
                class="w-full px-3 py-2.5 bg-main border border-border-base rounded-xl text-sm text-content appearance-none bg-no-repeat bg-right pr-8 focus:outline-none"
                style="
