      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="space-y-2">
          ...
          <input
            ...
            class="w-full px-4 py-2.5 bg-subtle border border-base rounded-xl text-sm focus:ring-4 focus:ring-accent/10 focus:border-accent outline-none placeholder:text-muted  transition-all"
            autofocus
            (keyup.enter)="onSave()"
          />
        </div>
        ...
        <div class="space-y-2">
          ...
          <select
            [(ngModel)]="orientation"
            class="w-full px-4 py-2.5 bg-subtle border border-base rounded-xl text-sm focus:ring-4 focus:ring-accent/10 focus:border-accent outline-none  transition-all cursor-pointer"
          >
