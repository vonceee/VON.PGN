  ...
  template: `
    ...
    <div class="prose prose-slate max-w-none text-gray-500">
      ...
      <div class="space-y-8 my-8">
        <div id="collaborative-studies" class="border-l-4 border-blue-600 pl-6 py-1">
          ...
          <p class="text-sm leading-relaxed text-gray-500">
            ...
            analyze with friends in real-time. Simply create a study from the <a routerLink="/study"
              class="text-blue-600 underline">Studies list</a> and share the link.
          </p>
        </div>

        <div id="opening-drills" class="border-l-4 border-blue-600 pl-6 py-1">
          ...
          <p class="text-sm leading-relaxed text-gray-500">
            Build muscle memory for your opening repertoire. In the <a routerLink="/study/drills"
              class="text-blue-600 underline">Drills section</a>, you can practice your white and black repertoires.
            The system simulates computer responses based on your loaded moves to test your knowledge.
          </p>
        </div>

        <div id="world-championships-database" class="border-l-4 border-blue-600 pl-6 py-1">
          ...
          <p class="text-sm leading-relaxed text-gray-500">
            ...
            under the <a routerLink="/world-championships" class="text-blue-600 underline">World Championships
              archive</a>.
          </p>
        </div>
      </div>
