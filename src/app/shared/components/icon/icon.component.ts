...
export type IconName = 'chevron-down' | 'search' | 'user' | 'close' | 'x' | 'trash' | 'loader' | 'hamburger' | 'sun' | 'moon' | 'trophy' | 'arrow-right' | 'calendar' | 'video' | 'target' | 'check' | 'users' | 'timer' | 'graduation-cap' | 'external-link';
